...
async def create_signature_envelope(
    ...
    *,
    ...
    # The approved concrete adapter must submit this immutable snapshot and later
    # bind its provider envelope id by webhook metadata. No local signature is possible.
    envelope = SignatureEnvelope(
        tenant_id=user.tenant_id,
        document_id=document.id,
        document_version=document_version,
        document_hash=document_version_digest(version),
        provider=provider,
